...
import com.liferay.training.space.gradebook.exception.NoSuchAssignmentException;
import com.liferay.training.space.gradebook.model.Assignment;
import com.liferay.training.space.gradebook.model.AssignmentTable;
import com.liferay.training.space.gradebook.model.impl.AssignmentImpl;
import com.liferay.training.space.gradebook.model.impl.AssignmentModelImpl;
import com.liferay.training.space.gradebook.service.persistence.AssignmentPersistence;
import com.liferay.training.space.gradebook.service.persistence.AssignmentUtil;
...
public class AssignmentPersistenceImpl
	 ...
	 */
	@Override
	public List<Assignment> findByResourceBlockId(long resourceBlockId) {
	 ...
	 */
	@Override
	public List<Assignment> findByResourceBlockId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Assignment assignment : list) {
					if (resourceBlockId != assignment.getResourceBlockId()) {
						list = null;
	 ...
	 */
	@Override
	public Assignment findByResourceBlockId_First(
			long resourceBlockId,
			OrderByComparator<Assignment> orderByComparator)
		throws NoSuchAssignmentException {

		Assignment assignment = fetchByResourceBlockId_First(
	 ...
	 */
	@Override
	public Assignment fetchByResourceBlockId_First(
		long resourceBlockId, OrderByComparator<Assignment> orderByComparator) {

		List<Assignment> list = findByResourceBlockId(
	 ...
	 */
	@Override
	public Assignment findByResourceBlockId_Last(
			long resourceBlockId,
			OrderByComparator<Assignment> orderByComparator)
		throws NoSuchAssignmentException {

		Assignment assignment = fetchByResourceBlockId_Last(
			resourceBlockId, orderByComparator);
	 ...
	 */
	@Override
	public Assignment fetchByResourceBlockId_Last(
		long resourceBlockId, OrderByComparator<Assignment> orderByComparator) {
	 ...
	 */
	@Override
	public Assignment[] findByResourceBlockId_PrevAndNext(
		...
		try {
			...
			array[0] = getByResourceBlockId_PrevAndNext(
				session, assignment, resourceBlockId, orderByComparator, true);

			array[1] = assignment;

			array[2] = getByResourceBlockId_PrevAndNext(
				session, assignment, resourceBlockId, orderByComparator, false);
	...
	protected Assignment getByResourceBlockId_PrevAndNext(
		Session session, Assignment assignment, long resourceBlockId,
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByResourceBlockId = new FinderPath(
			...
			new String[] {"resourceBlockId"}, true);
		...
		_finderPathCountByResourceBlockId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			new String[] {"resourceBlockId"}, false);
