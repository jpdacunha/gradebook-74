...
public class AssignmentIndexerV0 extends BaseIndexer<Assignment> {
	public AssignmentIndexerV0() {
	...
	protected void doReindex(Assignment assignment)
		...
		IndexWriterHelperUtil.updateDocument(assignment.getCompanyId(), document);
	}
	...
	private static final Log _log =
		LogFactoryUtil.getLog(AssignmentIndexerV0.class);
