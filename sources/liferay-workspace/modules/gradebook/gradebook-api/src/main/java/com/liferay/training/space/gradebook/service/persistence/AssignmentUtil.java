...
package com.liferay.training.space.gradebook.service.persistence;
...
public class AssignmentUtil {
	 ...
	 */
	public static Assignment findByResourceBlockId_First(
			long resourceBlockId,
			OrderByComparator<Assignment> orderByComparator)
		throws com.liferay.training.space.gradebook.exception.
			NoSuchAssignmentException {

		return getPersistence().findByResourceBlockId_First(
	...
	public static Assignment fetchByResourceBlockId_First(
		...
		return getPersistence().fetchByResourceBlockId_First(
			resourceBlockId, orderByComparator);
	}
	 ...
	 * @throws NoSuchAssignmentException if a matching assignment could not be found
	 */
	public static Assignment findByResourceBlockId_Last(
			long resourceBlockId,
			OrderByComparator<Assignment> orderByComparator)
		throws com.liferay.training.space.gradebook.exception.
			NoSuchAssignmentException {

		return getPersistence().findByResourceBlockId_Last(
			resourceBlockId, orderByComparator);
	}
	 ...
	 */
	public static Assignment fetchByResourceBlockId_Last(
		long resourceBlockId, OrderByComparator<Assignment> orderByComparator) {

		return getPersistence().fetchByResourceBlockId_Last(
			resourceBlockId, orderByComparator);
	}
	...
	public static Assignment[] findByResourceBlockId_PrevAndNext(
		...
		return getPersistence().findByResourceBlockId_PrevAndNext(
			assignmentId, resourceBlockId, orderByComparator);
	}
	...
	public static void setPersistence(AssignmentPersistence persistence) {
