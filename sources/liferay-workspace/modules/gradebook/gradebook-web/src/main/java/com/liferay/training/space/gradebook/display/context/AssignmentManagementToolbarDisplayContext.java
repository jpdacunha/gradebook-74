...
public class AssignmentManagementToolbarDisplayContext {

	public AssignmentManagementToolbarDisplayContext(
		HttpServletRequest httpServletRequest,
		LiferayPortletRequest liferayPortletRequest,
		LiferayPortletResponse liferayPortletResponse,
		BookmarksGroupServiceOverriddenConfiguration bookmarksGroupServiceOverriddenConfiguration,
		...
		_bookmarksGroupServiceOverriddenConfiguration = bookmarksGroupServiceOverriddenConfiguration;
		...
		_folderId = GetterUtil.getLong((String)httpServletRequest.getAttribute("view.jsp-folderId"));
		_searchContainer = (SearchContainer)httpServletRequest.getAttribute("view.jsp-bookmarksSearchContainer");
	...
	public CreationMenu getCreationMenu() {
		...
		if (!portletName.equals(GradebookPortletKeys.PORTLET_NAME)) {
			return null;
		}
